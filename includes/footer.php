...
// Build query - PENTING: Filter by canteen_info_id
$where = ["m.deleted_at IS NULL", "m.canteen_info_id = $canteen_info_id"];
...
// Get menus - hanya menu milik owner ini
$query = "SELECT 
    m.*,
...
// Get canteen info
$canteen_query = "SELECT canteen_name FROM canteen_info WHERE id = $canteen_info_id LIMIT 1";
...
<div class="row mb-4">
    <div class="col">
        <h2><i class="bi bi-card-list"></i> Kelola Menu - <?php echo htmlspecialchars($canteen['canteen_name']); ?></h2>
        <p class="text-muted">Tambah, edit, atau hapus menu makanan dan minuman warung Anda</p>
    </div>
    <div class="col-auto">
